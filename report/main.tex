...
Peak sessions run at 10:00\,ET (within the 8\,AM--2\,PM US East Coast peak band);
...
\begin{itemize}
    \item \textbf{Peak}: 10:00\,ET --- within the 8\,AM--2\,PM Eastern peak band.
...
\paragraph{Limited complete-slot coverage.}
Of 54 executed slots, only 7 met the completeness threshold of 360 rows.
Partial slots were caused predominantly by Google API rate-limiting (HTTP 429/503), which
disproportionately affected non-peak slots and may introduce selection bias.
